...
с точки зрения arduino самое главное: не нужно руками записывать битики в сдвиговый регистр управляя при этом тактированием CLK.
Для этого уже есть встроенная фунция `shiftOut` (sadge)
